...
<%@ page import="com.aprendiendo.jobapp.model.JobPost" %>
<%@ page import="com.aprendiendo.jobapp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/in/santiago-lopez-de-haro-2a1a4029a/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
